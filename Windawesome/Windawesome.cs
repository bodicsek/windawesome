...
namespace Windawesome
{
  public sealed class Windawesome : NativeWindow
  {
    ...
    private readonly Dictionary<IntPtr, LinkedList<Tuple<Workspace, Window>>> applications;
    // hWnd to a list of workspaces and windows
    private WindowBase[] topmostWindows;
    ...
    private IntPtr windowDestroyedShownOrHiddenWinEventHook;
    private IntPtr windowMinimizedOrRestoredWinEventHook;
    private IntPtr windowFocusedWinEventHook;
