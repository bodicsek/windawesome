...
def subscribe(modifiers, key)
	Windawesome::Plugins::ShortcutsManager.subscribe modifiers, key, lambda {
		ret = yield
...
modifiers = Windawesome::Plugins::ShortcutsManager::KeyModifiers
...
subscribe modifiers.Alt | modifiers.Shift, key.T do # change layout to Tile
	windawesome.current_workspace.change_layout Windawesome::Layouts::TileLayout.new
end

subscribe modifiers.Alt | modifiers.Shift, key.M do # change layout to Full Screen
	windawesome.current_workspace.change_layout Windawesome::Layouts::FullScreenLayout.new
end

subscribe modifiers.Alt | modifiers.Shift, key.F do # change layout to Floating
	windawesome.current_workspace.change_layout Windawesome::Layouts::FloatingLayout.new
end
